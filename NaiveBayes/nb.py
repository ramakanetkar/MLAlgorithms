...
def main():
    ...
    for word, count in l_Counter.items():
        lib_training_dict[word] = count
    #print(len(lib_training_words))
    #print(len(lib_word_count))
    set_con_training_words = set(list(con_training_dict))
    set_lib_training_words = set(list(lib_training_dict))
    vocab_text = set(list(con_training_dict) + list(lib_training_dict))
        ...
        for t_word in test_words:
            ...
            if t_word in vocab_text:
                ...
                if t_word in set_con_training_words:
                    t_con_word_count = con_training_dict[t_word]
             ...
             #   print(con_log_product)
                ...
                if t_word in set_lib_training_words:
                    t_lib_word_count = lib_training_dict[t_word]
